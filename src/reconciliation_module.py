...
default_minio_policies = {'consoleAdmin','diagnostics','readonly','readwrite','writeonly'}
default_keycloak_roles = {'default-roles-master','admin','offline_access','create-realm','uma_authorization'}
...
def update_policies_from_yaml(roles_list,existing_policies):
    ...
    policies_to_delete = (set(existing_policies) - default_minio_policies) - policy_names_set
...
def update_client_roles(policy_names_set,exisitng_client_roles):
    ...
    client_roles_to_delete = (exisitng_client_roles - default_client_roles) - policy_names_set
