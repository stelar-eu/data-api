        ...
        if not request.headers["Authorization"] is None:
            ...
            return {
                ...
                "error": {
                    "__type": "Authorization Error",
                    "name": [
                        "No Access Token specified. Please specify a valid Authorization Bearer token in the headers of your request."
                    ],
                },
            }
                    ...
                    if artifact is None:
                        return (
                            jsonify(
                                {
                                    "success": False,
                                    "message": f"This resource {artifact} cannot be fetched by CKAN",
                                }
                            ),
                            500,
                        )
