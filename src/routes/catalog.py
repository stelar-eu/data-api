...
def generate_list_entities(entity: Entity):
    ...
    @catalog_bp.get(f"/{entity.collection_name}")
    @catalog_bp.input(schema.PaginationParameters, location="query")
...
def generate_fetch_entities(entity: Entity):
    ...
    @catalog_bp.get(f"/{entity.collection_name}.fetch")
    @catalog_bp.input(schema.PaginationParameters, location="query")
...
def generate_get_entity(entity: Entity):
    ...
    @catalog_bp.get(f"/{entity.name}/<entity_id>")
...
def generate_delete_entity(entity: Entity):
    @catalog_bp.delete(f"/{entity.name}/<entity_id>")
    @catalog_bp.input(schema.DeleteRequest, location="query")
...
def generate_create_entity(entity: Entity):
    ...
    @catalog_bp.post(f"/{entity.name}")
    @catalog_bp.input(entity.creation_schema, location="json")
    @catalog_bp.output(schema.APIResponse, status_code=200)
    @catalog_bp.doc(
...
def generate_update_entity(entity: Entity):
    ...
    @catalog_bp.put(f"/{entity.name}/<entity_id>")
    @catalog_bp.input(entity.update_schema, location="json")
    @catalog_bp.output(schema.APIResponse, status_code=200)
    @catalog_bp.doc(
...
def generate_patch_entity(entity: Entity):
    ...
    @catalog_bp.patch(f"/{entity.name}/<entity_id>")
    @catalog_bp.input(entity.update_schema, location="json")
    @catalog_bp.output(schema.APIResponse, status_code=200)
    @catalog_bp.doc(
        summary=f"Update {entity.name} by ID",
...
def generate_add_member(member_entity: MemberEntity):
    ...
    @catalog_bp.input(member_entity.capacity_schema, location="json")
    @catalog_bp.output(schema.APIResponse, status_code=200)
    @catalog_bp.doc(
...
def generate_list_members(member_entity: MemberEntity):
    ...
    @catalog_bp.input(member_entity.capacity_schema, location="query")
    @catalog_bp.output(schema.MemberListResponse, status_code=200)
    @catalog_bp.doc(
