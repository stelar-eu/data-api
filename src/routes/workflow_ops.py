...
workflow_ops_bp = APIBlueprint('workflow_ops_blueprint', __name__,tag='Workflow Operations')
...
@workflow_ops_bp.route('/execution/create', methods=['POST'])
@workflow_ops_bp.input(schema.Workflow_Input, location='json', example={
                                                        #"workflow_id": "workflow_id", 
                                                        "tags": {}})
# @workflow_ops_bp.output(schema.ResponseOK, status_code=200)
@workflow_ops_bp.doc(tags=['Tracking Operations'], security=security_doc)
@auth.login_required
...
@workflow_ops_bp.route('/execution/read', methods=['GET'])
@workflow_ops_bp.input(schema.Identifier, location='query', example="24a976c4-fd84-47ef-92cc-5d5582bcaf41")
# @workflow_ops_bp.output(schema.ResponseOK, status_code=200)
@workflow_ops_bp.doc(tags=['Tracking Operations'], security=security_doc)
@auth.login_required
...
@workflow_ops_bp.route('/execution/commit', methods=['POST'])
@workflow_ops_bp.input(schema.Workflow_Commit, location='json', example={"workflow_exec_id": "24a976c4-fd84-47ef-92cc-5d5582bcaf41",
                                                             "state": "succeeded"})
# @workflow_ops_bp.output(schema.ResponseOK, status_code=200)
@workflow_ops_bp.doc(tags=['Tracking Operations'], security=security_doc)
@auth.login_required
...
@workflow_ops_bp.route('/execution/delete', methods=['GET'])
@workflow_ops_bp.input(schema.Identifier, location='query', example="24a976c4-fd84-47ef-92cc-5d5582bcaf41")
# @workflow_ops_bp.output(schema.ResponseOK, status_code=200)
@workflow_ops_bp.doc(tags=['Tracking Operations'], security=security_doc)
@auth.login_required
...
@workflow_ops_bp.route('/statistics', methods=['POST'])
@workflow_ops_bp.input(schema.Workflow_Statistics, location='json', example={"workflow_tags": ["A3-4"],
...
@workflow_ops_bp.route('/task/execution/create', methods=['POST'])
@workflow_ops_bp.input(schema.Task_Input, location='json', example={"workflow_exec_id": "24a976c4-fd84-47ef-92cc-5d5582bcaf41",
...
@workflow_ops_bp.route('/task/execution/input_json', methods=['GET'])
@workflow_ops_bp.input(schema.Identifier, location='query', example="24a976c4-fd84-47ef-92cc-5d5582bcaf41")
# @workflow_ops_bp.output(schema.ResponseOK, status_code=200)
@workflow_ops_bp.doc(tags=['Tracking Operations'], security=security_doc)
@auth.login_required
...
@workflow_ops_bp.route('/task/execution/output_json', methods=['POST'])
@workflow_ops_bp.input(schema.Task_Output, location='json', example={"task_exec_id": "4a142419-2342-4495-bfa3-9b4b3c2cad2a",
                                                        "output_json": {
...
@workflow_ops_bp.route('/task/execution/read', methods=['GET'])
@workflow_ops_bp.input(schema.Identifier, location='query', example="24a976c4-fd84-47ef-92cc-5d5582bcaf41")
# @workflow_ops_bp.output(schema.ResponseOK, status_code=200)
@workflow_ops_bp.doc(tags=['Tracking Operations'], security=security_doc)
@auth.login_required
...
@workflow_ops_bp.route('/task/execution/delete', methods=['GET'])
@workflow_ops_bp.input(schema.Identifier, location='query', example="4a142419-2342-4495-bfa3-9b4b3c2cad2a")
# @workflow_ops_bp.output(schema.ResponseOK, status_code=200)
@workflow_ops_bp.doc(tags=['Tracking Operations'], security=security_doc)
@auth.login_required
