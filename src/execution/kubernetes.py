...
class K8sExecEngine(ExecEngine):
    ...
    def create_task(self, tool_name: str, token: str, task_id: str, signature: str) -> tuple[str, str]:
        try:
            job_manifest = self._create_job_manifest(tool_name, token, task_id, signature)
