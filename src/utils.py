...
sql_workflow_execution_templates = {
    'workflow_create_template': 'INSERT INTO klms.workflow_execution(workflow_uuid, state, start_date) VALUES (_WORKFLOW_UUID, _STATE, _START_TIMESTAMP)',
    'workflow_update_template': 'UPDATE klms.workflow_execution SET state = _STATE, end_date = _END_TIMESTAMP WHERE workflow_uuid = _WORKFLOW_UUID',   
    'workflow_insert_tags_template': 'INSERT INTO klms.workflow_tag VALUES (_WORKFLOW_UUID, _KEY, _VALUE)',
    'workflow_state_template': 'SELECT workflow_uuid AS workflow_exec_id, state FROM klms.workflow_execution WHERE workflow_uuid = _WORKFLOW_UUID',
    'workflow_delete_template': 'DELETE FROM klms.workflow_execution WHERE workflow_uuid = _WORKFLOW_UUID',
    'workflow_read_template': 'SELECT workflow_uuid AS workflow_exec_id, state, start_date, end_date FROM klms.workflow_execution WHERE workflow_uuid = _WORKFLOW_UUID',
    'workflow_read_tags_template': 'SELECT key, value FROM klms.workflow_tag WHERE workflow_uuid = _WORKFLOW_UUID',
    'task_create_template': 'INSERT INTO klms.task_execution(task_uuid, workflow_uuid, state, start_date) VALUES (_TASK_UUID, _WORKFLOW_UUID, _STATE, _START_TIMESTAMP)',
    'task_update_template': 'UPDATE klms.task_execution SET state = _STATE, end_date = _END_TIMESTAMP WHERE task_uuid = _TASK_UUID',
    'task_create_connection_template': 'UPDATE klms.task_execution SET next_task_uuid = _NEXT_TASK_UUID WHERE task_uuid = _TASK_UUID',
    'task_delete_template': 'DELETE FROM klms.task_execution WHERE task_uuid = _TASK_UUID',
    'task_read_template': 'SELECT task_uuid AS task_exec_id, workflow_uuid AS workflow_exec_id, state, start_date, end_date FROM klms.task_execution WHERE task_uuid = _TASK_UUID',
